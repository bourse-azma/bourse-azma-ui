            ...
            <div
                ...
                <div>
                    ...
                    <p className="mt-6 text-base font-medium leading-9 text-[#D8E6F7]">
                        بورس‌آزما سامانه معاملاتی پیشرفته برای بازار سرمایه ایران است.
                        اینجا می‌توانید با خیالی آسوده استراتژی بسازید، سفارشات خود را با بالاترین سرعت ثبت کنید و عملکرد پورتفوی خود را در لحظه بسنجید.
                    </p>
                    <p className="mt-4 text-sm font-medium leading-8 text-[#AFC1D8]">
                        تمرکز ما روی تجربه‌ای امن و سریع، ارائه ابزارهای تحلیلی حرفه‌ای و محیطی پایدار است که
                        نیازهای واقعی معامله‌گران را به بهترین شکل پاسخ دهد.
                    </p>
                </div>
