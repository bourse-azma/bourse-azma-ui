...
export default function SymbolSearchCombobox({
  ...
  return (
    <div dir="rtl" ref={rootRef} className="relative block lg:col-span-7">
      ...
      />
      {loading ? <Loader2 className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 animate-spin text-muted" /> : null}

      {open ? (
        <div className="absolute inset-x-0 top-[calc(100%+2px)] z-50 overflow-hidden rounded-xl border border-border/80 bg-surface shadow-card">
